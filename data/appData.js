export const appData = {
  ...
  timelineContent: [
    {
      title: "Trigger | Coca Cola Event",
      desc: "I built a heavily animated interactive experience to provide several key pieces of information for users during a live in-person Coca Cola event. The experience had several avenues a user could take with each opening several more routes for users to explore. With each link clicked a full screen animation would play to reveal the new information.",
    ...
    {
      title: "Trigger | Miller Bigfoot AI Experience",
      desc: "I worked as the sole developer on this AI based project. We worked with creators of an AI platform called CharismaAI to create a 3D webAR bigfoot experience that would allow users to have a real time chat with bigfoot using either their voice or an in-app chatbox in augmented reality.",
      projectImg: "/images/bigfoot.jpg",
      imageAlt: "Miller Lite Bigfoot AI Experience",
      timeLineIcon: "/images/display.svg",
      timeLineIconAlt: "Trigger XR",
      url: "https://www.triggerxr.com/work/miller-lite-bigfoot-ai-webar",
    ...
    },
    {
      ...
      desc: "My daughter was born on December 23rd 2022. Yay for Christmas baby!",
    ...
    {
      title: "Trigger | La Brea Sinkhole Experience",
...

    {
      ...
      projectImg: "/images/pepsi.webp",
      imageAlt: "The Pepsi PureLeaf Experience",
      timeLineIcon: "images/display.svg",
      timeLineIconAlt: "Trigger XR",
    ...
    {
      title: "Trigger | Super Bowl Halftime Show",
      ...
      projectImg: "/images/sb.webp",
      imageAlt: "Trigger | Super Bowl Halftime Show",
      timeLineIcon: "images/display.svg",
      timeLineIconAlt: "Trigger XR",
    ...
    {
      title: "Trigger | Culver City Project",
    ...
    {
      title: "Trigger | Molson Coors Projects",
      desc: "I was assigned to the Molson Coors projects where I got to work on several of their marketing campaigns. This included a holiday sweepstakes that leveraged machine learning to recognize seasonal cans, augmented reality web based cornhole games, and more.",
      timeLineIcon: "images/display.svg",
      timeLineIconAlt: "Trigger XR",
