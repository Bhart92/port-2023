			        ...
			        <div className={` ${serviceStyles.topServiceWrapper} mx-auto my-0 `}>
				        ...
				        <article className="max-w-[1050px] mx-auto 2xl:max-w-[1500px]">
				            <p className="text-base w-9/12 my-6 m-auto leading-7 text-center md:mb-10">
				              We offer full stack and front end web development. Each package includes a hosting, a free logo,
				              ten edits, and full ownership. We don't hold you hostage with monthly fees - 
				              your website is yours. In addition, for a small monthly subscription you can have 24/7 direct access to
				              a professional developer whenever you want to make changes.
				            </p>
				        </article>
			        ...
			        <div className="pt-10 pb-10 mx-auto my-0">
		          	...
		          	<div>
			            ...
			            <p className="text-base w-9/12 my-6 m-auto leading-7 text-center">
			          	We utilize modern web frameworks and best practices to optimize everything, everywhere. Using tools created by
			          	Google we diligently scan every website to ensure it is optmized for search engines and users. We will setup your Google Business account
			          	and help you get to the top of search engine results.
			          	</p>
			          	</article>
						{generateImage()}
				        <div className="flex flex-col items-center mx-auto w-[75%] md:items-start ">
